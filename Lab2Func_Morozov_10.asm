...
Filter_asm PROC	; [RCX] - pDst
	...
	sub     r10,        r8       ;   (слагаемое -10 взялось от того, что за раз мы обрабатываем 8 пикселов, причем rdx и rax
	sub     r10,        r8       ;    указывают на угол, соответствующий левому верхнему углу матрицы ядра фильтра Лапласа)
	...
	m1:			
		...
		add         rcx,   8              ;   текущей строки => смещаемся на 8 пикселов	
